...
public class TelaCadastroLentes {
	...
	private static void placeComponents(JPanel panel) {
		...
		grauLabel.setBounds(70, 160, 80, 25);
		panel.add(grauLabel);
		
		JTextField grauText = new JTextField(20);
		grauText.setBounds(140, 160, 160, 25);
		panel.add(grauText);
		
		JButton registerButton = new JButton("Cadastrar");
		registerButton.setBounds(140, 220, 100, 25);
